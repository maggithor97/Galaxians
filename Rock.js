...
function Rock(descr) {
    ...
    this.sprite = this.sprite || g_sprites.rocks;
...
Rock.prototype.getRadius = function () {
    return this.scale * (this.sprite.width / 2) * 0.8;
};
...
Rock.prototype.takeBulletHit = function () {
    ...
    if (this.scale > 0.25) {
        ...
        this.splitSound.volume = 0.2;
        this.splitSound.play();
    } else {
        this.evaporateSound.volume = 0.2;
...
Rock.prototype.render = function (ctx) {
    ...
    if (this.animationFrameCounter % this.animationRate === 0) {
